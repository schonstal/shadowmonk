package
{
	...
	public class Level2 extends FlxState
	{
        ...
        [Embed(source = '../data/exports/lvl02/layer_0.txt', mimeType = "application/octet-stream")] private var GroundMap:Class;
        [Embed(source = '../data/exports/lvl02/layer_1.txt', mimeType = "application/octet-stream")] private var WallMap:Class;
        ...
        public function Level2()
		{
            ...
            addGuard(new Array(new Point(7,13), new Point(13,13), new Point(13, 18), new Point(13, 15)), 1);
